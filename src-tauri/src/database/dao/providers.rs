...
impl Database {
    pub fn get_all_providers(
        ...
        let mut stmt = conn.prepare(
            "SELECT id, name, settings_config, website_url, category, created_at, sort_index, notes, icon, icon_color, meta, in_failover_queue, alias
    ...
    pub fn get_provider_by_id(
        ...
        let result = conn.query_row(
            "SELECT name, settings_config, website_url, category, created_at, sort_index, notes, icon, icon_color, meta, in_failover_queue, alias
        ...
        if is_update {
            ...
            tx.execute(
                "INSERT INTO providers (
                    ...
                    created_at, sort_index, notes, icon, icon_color, meta, is_current, in_failover_queue, alias
